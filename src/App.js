...
class App extends Component {
    ...
    <form onSubmit={this.searchUsers}>
      <div className="row">
        <div className="col-sm-4">
          <p>
            Nombres
            <input type="text" className="pdn_input" name="names"  />
          </p>
        </div>
        <div className="col-sm-4">
          <p>
            Primer apellido
            <input type="text" className="pdn_input" name="surname-a"  />
          </p>
        </div>
        <div className="col-sm-4">
          <p>
            ...
            <div className="col-sm-9">
              <div className="row">
                <div className="col-sm-3">
                  ...
                  <p>
                    <label>
                      <input type="radio" name="nivel" value=""  />Todos
                    </label>
                  </p>
                </div>
                <div className="col-sm-3">
                  <p>
                    <label>
                      <input type="radio" name="nivel" value="FED"  />Federal
                    </label>
                  </p>
                </div>
                <div className="col-sm-3">
                  <p>
                    <label>
                      <input type="radio" name="nivel" value="EST"  />Estatal
                    </label>
                  </p>
                </div>
                <div className="col-sm-3">
                  <p>
                    <label>
                      <input type="radio" name="nivel" value="MUN"  />Municipal
                    </label>
                  </p>
                </div>
              </div>
  ...
  // esta es una función como en lo de methods
  searchUsers(e){
    e.preventDefault();
    console.log(this, e);
  }
