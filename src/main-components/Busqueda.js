...
class Busqueda extends Component{
	...
	render(){
		return(
			/* El template de esta maroma */
			/*  REACT STYLE */
			/*  igual comienza con un div que contiene todo :P */
			<div>
		    ...
		    <form>
		    	...
		    	<p>
		    		Primer apellido
		    	{/* en el JSX hay que cerrar todos los tags*/}
		    		<input />
		    	</p>
		    ...
		    { /* aquí sí apliqué el copy-paste */}
		    {/* en lugar de class hay que usar className, pos porque java style */}
