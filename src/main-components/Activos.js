...
class Activos extends Component{
	...
	<div className="col-sm-3 sidebar">
	    ...
	    <li>
	  	  <Link className={ section == "bienes-muebles" ?"router-link-exact-active router-link-active" : ""}  to={`/perfil/${this.props.profile._id}/activos/bienes-muebles`}>
	  	    Bienes muebles registrables <span>{this.props.profile.activos.bienes_muebles_registrables.length}</span>
	  	  </Link>
	    </li>

	    <li>
	  	  <Link className={ section == "bienes-muebles-no-registrables" ?"router-link-exact-active router-link-active" : ""} to={`/perfil/${this.props.profile._id}/activos/bienes-muebles-no-registrables`}>
	  	    Bienes muebles no registrables <span>{this.props.profile.activos.bienes_muebles_no_registrables.length}</span>
	  	  </Link>
	    </li>

	    <li>
	  	  <Link className={ section == "inversiones" ?"router-link-exact-active router-link-active" : ""} to={`/perfil/${this.props.profile._id}/activos/inversiones`}>
	  	    Inversiones <span>{this.props.profile.activos.inversiones_cuentas_valores.length}</span>
	  	  </Link>
	    </li>

	    <li>
	  	  <Link className={ section == "efectivo-y-metales" ?"router-link-exact-active router-link-active" : ""} to={`/perfil/${this.props.profile._id}/activos/efectivo-y-metales`}>
	  	    Efectivo y metales <span>{this.props.profile.activos.efectivo_metales.length}</span>
	  	  </Link>
	    </li>

	    <li>
	  	  <Link className={ section == "fideicomisos" ?"router-link-exact-active router-link-active" : ""} to={`/perfil/${this.props.profile._id}/activos/fideicomisos`}>
	  	    Fideicomisos <span>{this.props.profile.activos.fideicomisos.length}</span>
	  	  </Link>
	    </li>

	    <li>
	  	  <Link className={ section == "bienes-intangibles" ?"router-link-exact-active router-link-active" : ""} to={`/perfil/${this.props.profile._id}/activos/bienes-intangibles`}>
	  	    Bienes intangibles <span>{this.props.profile.activos.bienes_intangibles.length}</span>
	  	  </Link>
	    </li>

	    <li>
	  	  <Link className={ section == "cuentas-por-cobrar" ?"router-link-exact-active router-link-active" : ""} to={`/perfil/${this.props.profile._id}/activos/cuentas-por-cobrar`}>
	  	    Cuentas por cobrar <span>{this.props.profile.activos.cuentas_por_cobrar.length}</span>
	  	  </Link>
	    </li>

	    <li>
	  	  <Link className={ section == "beneficios-en-especie" ?"router-link-exact-active router-link-active" : ""} to={`/perfil/${this.props.profile._id}/activos/beneficios-en-especie`}>
