   ...
   */
	render(){
            ...
            <p>
              <label>
                <input type="radio" 
                       ...
                       value=""
                       onChange={this.handleInputChange} />Todos
              </label>
            </p>
          </div>
          <div className="col-sm-3">
      ...
      <input type="radio" 
             ...
             onChange={this.handleInputChange}  />Federal
      </label>
      </p>
      </div>
      <div className="col-sm-3">
      ...
      <input type="radio" 
             ...
             onChange={this.handleInputChange}  />Estatal
      </label>
      </p>
      </div>
      <div className="col-sm-3">
      ...
      <input type="radio" 
             ...
             onChange={this.handleInputChange}  />Municipal
      </label>
      </p>
      </div>
      </div>
      ...
      <div className="col-sm-4">
      <p><input type="submit" className="pdn_input" name="submit" value="buscar" /></p>
      </div>
      </div>
      </form>
		);
